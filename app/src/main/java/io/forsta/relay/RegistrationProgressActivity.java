...
import io.forsta.librelay.service.RegistrationService;
import static io.forsta.librelay.service.RegistrationService.RegistrationState;
...
public class RegistrationProgressActivity extends BaseActionBarActivity {
  ...
  private void initializeLinks() {
    String          link            = getString(io.forsta.librelay.R.string.RegistrationProblemsActivity_possible_problems);
    ...
    spannableString.setSpan(new ClickableSpan() {
      ...
      public void onClick(View widget) {
        new AlertDialog.Builder(RegistrationProgressActivity.this)
                .setTitle(io.forsta.librelay.R.string.RegistrationProblemsActivity_possible_problems)
                .setView(io.forsta.librelay.R.layout.registration_problems)
  ...
  private void handleStateComplete() {
    if (visible) {
      Toast.makeText(this,
                     io.forsta.librelay.R.string.RegistrationProgressActivity_registration_complete,

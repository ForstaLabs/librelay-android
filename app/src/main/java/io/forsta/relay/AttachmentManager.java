...
import io.forsta.librelay.components.RemovableMediaView;
import io.forsta.librelay.components.ThumbnailView;
import io.forsta.librelay.components.location.SignalMapView;
...
import io.forsta.librelay.media.GifSlide;
import io.forsta.librelay.media.ImageSlide;
    ...
    future.addListener(new AssertedSuccessListener<Bitmap>() {
      ...
      public void onSuccess(@NonNull Bitmap result) {
        ...
        Uri           uri           = PersistentBlobProvider.getInstance(context)
            .create(blob, ContentType.IMAGE_PNG);
      ...
      protected void onPostExecute(@Nullable final Slide slide) {
        if (slide == null) {
          ...
          if (slide.hasAudio()) {
            ...
            thumbnail.setImageResource(slide, false);

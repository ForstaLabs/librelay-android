...
public class ContactsDatabase {
  ...
  private static final String CALL_MIMETYPE    = "vnd.android.cursor.item/vnd.io.forsta.librelay.call";
  ...
  public static void removeAllContacts(Context context) {
    ...
    Uri uri = ContactsContract.RawContacts.CONTENT_URI.buildUpon()
        .appendQueryParameter(ContactsContract.RawContacts.ACCOUNT_NAME, "Relay")
        .appendQueryParameter(ContactsContract.RawContacts.ACCOUNT_TYPE, "io.forsta.librelay")
        .appendQueryParameter(ContactsContract.CALLER_IS_SYNCADAPTER, "true").build();

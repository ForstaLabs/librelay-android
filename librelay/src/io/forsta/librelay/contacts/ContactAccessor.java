...
import static io.forsta.librelay.database.GroupDatabase.GroupRecord;
...
public class ContactAccessor {
  ...
  public Collection<ContactData> getContactsWithPush(Context context) {
    ...
    List<String> pushNumbers = new ArrayList<>(DbFactory.getContacts(context).getNumbers());
  ...
  public List<String> getNumbersForThreadSearchFilter(Context context, String constraint) {
    ...
    try {
      reader = DbFactory.getGroupDatabase(context).getGroupsFilteredByTitle(constraint);

      while ((record = reader.getNext()) != null) {
        numberList.add(record.getUid());
      }
    } finally {
      if (reader != null)
        reader.close();

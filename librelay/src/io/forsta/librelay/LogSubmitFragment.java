...
public class LogSubmitFragment extends Fragment {
  private static final String TAG = LogSubmitFragment.class.getSimpleName();
  ...
  private LogSubmitFragment.OnLogSubmittedListener mListener;

  public static LogSubmitFragment newInstance()
  {
    LogSubmitFragment fragment = new LogSubmitFragment();
    return fragment;
  }

  public LogSubmitFragment() { }
  ...
  public void onAttach(Activity activity) {
    ...
    try {
      mListener = (LogSubmitFragment.OnLogSubmittedListener) activity;

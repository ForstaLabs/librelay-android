...
public class SignedPrekeys extends DbBase {

  private static final String TAG = SignedPrekeys.class.getSimpleName();
  ...
  protected SignedPrekeys(Context context, DbHelper dbHelper) {

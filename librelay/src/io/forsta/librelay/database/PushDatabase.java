...
public class PushDatabase extends DbBase {
  ...
  public PushDatabase(Context context, DbHelper dbHelper) {
  ...
  public SignalServiceEnvelope get(long id) throws NoSuchMessageException {
    ...
    try {
      cursor = dbHelper.getReadableDatabase().query(TABLE_NAME, null, ID_WHERE,
  ...
  public void delete(long id) {
    dbHelper.getWritableDatabase().delete(TABLE_NAME, ID_WHERE, new String[] {id+""});
  }

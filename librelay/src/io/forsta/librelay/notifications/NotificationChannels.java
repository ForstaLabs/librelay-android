...
//    }
//
//    RecipientDatabase db = DbFactory.getRecipientDatabase(context);
//
...
//
//    DbFactory.getRecipientDatabase(context).setNotificationChannel(recipient, success ? newChannelId : null);
//  }
//
  /**
...
//    RecipientDatabase database = DbFactory.getRecipientDatabase(context);
//
